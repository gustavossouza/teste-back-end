        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Cadastrar Usuários</h1>
                    <form action="{{route('users.store')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="email" placeholder="Digite o email" required>
                        </div>

                        <div class="form-group">
                            <label for="name">Cellphone</label>
                            <input type="text" class="form-control" id="name" name="cellphone" placeholder="Digite o cellphone" required>
                        </div>
